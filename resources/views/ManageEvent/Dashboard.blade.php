                ...
                <div class="panel-body">
                    <ul class="rrssb-buttons clearfix">
                        <li class="rrssb-facebook">
                            ...
                            <span class="rrssb-icon">
                                <svg version="1.1" xmlns="https://www.w3.org/2000/svg"
                                     xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" width="28px"
                        ...
                        <li class="rrssb-linkedin">
                            <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{$event->event_url}}?utm_source=linkedin&amp;title={{urlencode($event->title)}}&amp;summary={{{Str::words(md_to_str($event->description), 20)}}}"
                               class="popup">
                            <span class="rrssb-icon">
                                <svg version="1.1" xmlns="https://www.w3.org/2000/svg"
                                     xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" width="28px"
                        ...
                        <li class="rrssb-twitter">
                            <a href="https://twitter.com/intent/tweet?text=Check out: {{$event->event_url}}?utm_source=twitter {{ Str::words(md_to_str($event->description), 20) }}"
                               class="popup">
                            <span class="rrssb-icon">
                                <svg version="1.1" xmlns="https://www.w3.org/2000/svg"
